...
enum class S_KeyButton
{
    ...
    KEY_PREVTRACK       = 0x90,    /* Previous Track (GUK_CIRCUMFLEX on Japanese keyboard) */
    ...
    /*
*  Alternate names f= or keys, to facilitate transition from DOS.
*/
...
public:
    S_BasicInput();
    bool isKeyDown( S_KeyButton keyButton );
    bool isMouseDown( S_MouseButton mouseButton );
    int mouseX() const;
    int mouseY() const;
    int mouseDX() const;
    int mouseDY() const;
