...
inline S_Vec4::S_Vec4( const float *i_array )
{
    m_data = glm::make_vec4( i_array );
}

inline S_Vec4::S_Vec4( const double *i_array )
{
    m_data = glm::make_vec4( i_array );
}

inline S_Vec4::S_Vec4( const S_Vec4 &i_vec ) : m_data( i_vec.m_data )
{
